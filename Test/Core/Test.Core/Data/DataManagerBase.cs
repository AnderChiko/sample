...
namespace Test.Core.Data
{
    ...
    public abstract class DataManagerBase<TModel, TKey, TDbContext>
        ...
        where TModel : class, new()
    {
        ...
        protected DataManagerBase(IServiceProvider serviceProvider)
        {
        ...
        public virtual async Task<DataResult<TModel>> Create(TModel entry)
        {
            ...
            using (var dbContext = GetDbContext())
            {
                ...
                var contextResult = dbContext.Add(entry);
